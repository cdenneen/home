...

{
  ...
  home.sessionVariables = {
    ...
    # to this value, so it must NOT include a "/v1" suffix. Without this,
    # `pi models`/chat via the litellm provider 404s on a doubled
    # /v1/v1/models path. Same reasoning applies to EROS_LITELLM_BASE_URL
    # in secrets.nix.
