...
- Alpha0 real data is structurally compatible, but signed Core-open, Hermes semantic restore, scheduler restoration and live gateway/provider behavior remain unverified.
