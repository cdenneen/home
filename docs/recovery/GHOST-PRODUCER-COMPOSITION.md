...
- `PRE_EXISTING_HOME_FAILURE`: reproduced unchanged on the exact base. No such failure is currently expected; the prior Darwin `minimal-vm.nix` `boot` failure was fixed on main before this update.
